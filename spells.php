  ...
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
	...
	<label for="experiencepoints"></label><a style="border-radius:50%;" href="index.php"><i class="fa fa-home" style="font-size:50px"></i></a>
		...
		<?php
			...
			echo '<span>   </span>';
			echo '<label for="experiencepoints"></label><a style="border-radius:50%;" href="rulebook.php?home=spells.php?id='.$player.'"><i class="fa fa-question-circle raz" style="font-size:50px"></i></a>';
